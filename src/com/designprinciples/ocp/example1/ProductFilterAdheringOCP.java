...
class ProductFilterAdheringOCPDemo {
	...
	public static void main(String args[]) {
		...
		pf.filter(products, new ColorSpecification(Color.GREEN)).forEach(p -> System.out.println(" - " + p.name + " is green"));
		
		System.out.println("Blue products : ");
		pf.filter(products, new ColorSpecification(Color.BLUE)).forEach(p -> System.out.println(" - " + p.name + " is blue"));
		
		System.out.println("Large products : ");
		pf.filter(products, new SizeSpecification(Size.LARGE)).forEach(p -> System.out.println(" - " + p.name + " is large"));
		...
		pf.filter(products, new AndSpecification<>(
				                ...
				                new SizeSpecification(Size.SMALL))).forEach(p -> System.out.println(" - " + p.name + " is green and small"));
